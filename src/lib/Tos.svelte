<div class="content">
    <h1 class="jsx-57d8601f98b8b551">Terms and Conditions</h1>
    <p class="jsx-57d8601f98b8b551">Last updated: August 23, 2022</p>
    <p class="jsx-57d8601f98b8b551">
      Please read these terms and conditions carefully before using Our Service.
    </p>
    <h2 class="jsx-57d8601f98b8b551">Interpretation and Definitions</h2>
    <h2 class="jsx-57d8601f98b8b551">Interpretation</h2>
    <p class="jsx-57d8601f98b8b551">
      The words of which the initial letter is capitalized have meanings defined
      under the following conditions. The following definitions shall have the
      same meaning regardless of whether they appear in singular or in plural.
    </p>
    <h2 class="jsx-57d8601f98b8b551">Definitions</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <ul class="jsx-57d8601f98b8b551">
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Affiliate</strong> means an
      ...
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Country</strong> refers to:
          Mexico<!-- -->
        </p>
      </li>
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Company</strong> (referred to as
      ...
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Device</strong> means any device
      ...
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Service</strong> refers to the
          Website.<!-- -->
        </p>
      </li>
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Terms and Conditions</strong>
      ...
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551"
      ...
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">Website</strong> refers to
          tactics.tools, accessible from<!-- -->
          <!-- --><a
            href="https://tactics.tools"
            rel="external nofollow noopener"
            target="_blank"
            class="jsx-57d8601f98b8b551"
            >https://tactics.tools</a
          >
        </p>
      </li>
      <li class="jsx-57d8601f98b8b551">
        <p class="jsx-57d8601f98b8b551">
          <strong class="jsx-57d8601f98b8b551">You</strong> means the individual
    ...
    <h2 class="jsx-57d8601f98b8b551">Acknowledgment</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Links to Other Websites</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Termination</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Limitation of Liability</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Governing Law</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Disputes Resolution</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">For European Union (EU) Users</h2>
    <p class="jsx-57d8601f98b8b551">
      If You are a European Union consumer, you will benefit from any mandatory
      provisions of the law of the country in which you are resident in.
    </p>
    <h2 class="jsx-57d8601f98b8b551">United States Legal Compliance</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Severability and Waiver</h2>
    <h2 class="jsx-57d8601f98b8b551">Severability</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Waiver</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Translation Interpretation</h2>
    <p class="jsx-57d8601f98b8b551">
      These Terms and Conditions may have been translated if We have made them
      available to You on our Service. You agree that the original English text
      shall prevail in the case of a dispute.
    </p>
    <h2 class="jsx-57d8601f98b8b551">Changes to These Terms and Conditions</h2>
    <p class="jsx-57d8601f98b8b551">
    ...
    <h2 class="jsx-57d8601f98b8b551">Contact Us</h2>
    <p class="jsx-57d8601f98b8b551">
      If you have any questions about these Terms and Conditions, You can
      contact us:
    </p>
    <ul class="jsx-57d8601f98b8b551">
      <li class="jsx-57d8601f98b8b551">By email: arguch@gmail.com</li>
    </ul>
</div>
